...
def main():
    ...
    channel.queue_declare(queue=os.getenv("RABBITMQ_QUEUE_NAME"),durable=True,arguments={"x-queue-type":"quorum",'x-delivery-limit':int(os.environ.get("MAX_RERUNS"))})
    ...
    def callback(ch, method, properties, body):
        try:
            ...
            report_failure(ch, method, properties, body)
    channel.basic_consume(queue=os.getenv("RABBITMQ_QUEUE_NAME"), on_message_callback=callback, auto_ack=False)
